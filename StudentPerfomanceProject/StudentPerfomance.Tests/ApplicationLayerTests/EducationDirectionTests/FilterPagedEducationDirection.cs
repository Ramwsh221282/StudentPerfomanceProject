...
public sealed class FilterPagedEducationDirection(FilterEducationDirectionRequest request, int page, int pageSize) : IService<IReadOnlyCollection<EducationDirection>>
{
	...
	public async Task<OperationResult<IReadOnlyCollection<EducationDirection>>> DoOperation()
	{
		...
		new(result, "Education Direction Paged Filter General Test");
		logger.ShowInfo();
