...
internal sealed class CreateBachelorEducationPlan : ICreateEducationPlanPolicy
{
	private readonly IRepository<Semester> _repository;
	private readonly EducationPlan _plan;
	public CreateBachelorEducationPlan(IRepository<Semester> repository, EducationPlan plan)
	{
