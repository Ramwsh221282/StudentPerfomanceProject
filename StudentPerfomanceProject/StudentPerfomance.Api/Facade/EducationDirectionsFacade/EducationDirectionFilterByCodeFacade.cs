...
internal sealed class EducationDirectionFilterByCodeFacade : EducationDirectionFilterFacade, IFacade<IReadOnlyCollection<EducationDirectionResponse>>
{
	public EducationDirectionFilterByCodeFacade(FilterEducationDirectionRequest request, FilterConstraint constraint, int page, int pageSize)
