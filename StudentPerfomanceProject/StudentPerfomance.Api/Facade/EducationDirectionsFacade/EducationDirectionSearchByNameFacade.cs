...
internal sealed class EducationDirectionSearchByNameFacade : EducationDirectionSearchFacade, IFacade<IReadOnlyCollection<EducationDirectionResponse>>
{
	public EducationDirectionSearchByNameFacade(FilterEducationDirectionRequest request, FilterConstraint constraint) : base(request, constraint) { }
