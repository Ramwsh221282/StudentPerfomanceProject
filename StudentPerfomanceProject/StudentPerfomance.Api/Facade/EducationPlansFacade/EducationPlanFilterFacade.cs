...
internal sealed class EducationPlanFilterFacade(EducationPlanGeneralRequest request, int page, int pageSize) : IFacade<IReadOnlyCollection<EducationPlanResponse>>
{
