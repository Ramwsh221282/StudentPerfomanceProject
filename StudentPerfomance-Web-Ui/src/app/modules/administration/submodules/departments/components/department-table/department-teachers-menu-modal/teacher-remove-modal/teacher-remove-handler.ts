...
import { TeacherRemoveNotification } from './teacher-remove-notification';
...
const createHandler =
  ...
  (parameter: Teacher): void => {
    const message = new TeacherRemoveNotification().buildMessage(parameter);
...
export const TeacherRemoveHandler = (
  service: UserOperationNotificationService,
  success: EventEmitter<void>,
  failure: EventEmitter<void>
