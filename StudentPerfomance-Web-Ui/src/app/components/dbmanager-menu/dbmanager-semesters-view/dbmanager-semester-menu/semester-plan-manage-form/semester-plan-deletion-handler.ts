...
import { SemesterPlanDeletedNotification } from './semester-plan-deleted-notification';
...
const createHandler =
  ...
  (parameter: SemesterPlan): void => {
    const message = new SemesterPlanDeletedNotification().buildMessage(
      parameter
    );
...
export const SemesterPlanDeletionHandler = (
  facadeService: SemesterPlanFacadeService,
  notificationService: UserOperationNotificationService,
  notificatable: INotificatable
