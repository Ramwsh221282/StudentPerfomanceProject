...
public sealed class JwtVerificationObject
{
	public string UserId { get; init; }
	public bool IsExpired { get; init; }

	public JwtVerificationObject(string token)
	{
	...
	{
		SymmetricSecurityKey securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(JwtProvider._secret));
