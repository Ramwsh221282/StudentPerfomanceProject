...
public static class GetEducationPlansByDirection
{
	...
	public sealed class Endpoint : IEndpoint
	{
		public void MapEndpoint(IEndpointRouteBuilder app) =>
			app.MapPost($"{EducationPlanTags.Api}/by-education-direction", Handler).WithTags($"{EducationPlanTags.Tag}");
	}

	public static async Task<IResult> Handler([FromBody] Request request, IUsersRepository users, IEducationDirectionRepository directions)
	{
