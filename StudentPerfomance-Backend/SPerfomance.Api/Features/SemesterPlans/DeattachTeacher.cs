...
public static class DeattachTeacher
{
	...
	public sealed class Endpoint : IEndpoint
	{
		public void MapEndpoint(IEndpointRouteBuilder app) =>
			app.MapPost($"{SemesterPlanTags.Api}/deattach-teacher", Handler).WithTags(SemesterPlanTags.Tag);
	}
	...
	)
	{
		...
		discipline = await new DeattachTeacherFromDisciplineCommandHandler(disciplines).Handle(new(discipline.Value));
