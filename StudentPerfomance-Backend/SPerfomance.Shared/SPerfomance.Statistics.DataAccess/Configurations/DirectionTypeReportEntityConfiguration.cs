...
internal class DirectionTypeReportEntityConfiguration
    : IEntityTypeConfiguration<DirectionTypeReportEntity>
{
    public void Configure(EntityTypeBuilder<DirectionTypeReportEntity> builder)
    {
