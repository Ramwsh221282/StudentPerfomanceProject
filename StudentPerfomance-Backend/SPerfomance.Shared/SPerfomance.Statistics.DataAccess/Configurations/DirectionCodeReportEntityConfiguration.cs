...
internal sealed class DirectionCodeReportEntityConfiguration
    : IEntityTypeConfiguration<DirectionCodeReportEntity>
{
    public void Configure(EntityTypeBuilder<DirectionCodeReportEntity> builder)
    {
