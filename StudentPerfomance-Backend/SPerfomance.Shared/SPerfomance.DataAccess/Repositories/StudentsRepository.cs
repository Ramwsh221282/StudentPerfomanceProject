...
public class StudentsRepository : IStudentsRepository
{
	...
	public async Task Insert(Student entity)
	{
		...
		string sql = "INSERT INTO Students (Id, Name_Name, Name_Surname, Name_Patronymic, State_State, Recordbook_Recordbook, AttachedGroupId, EntityNumber) VALUES (@Id, @Name, @Surname, @Patronymic, @State, @Recordbook, @GroupId, @Number)";
