...
public interface IEducationDirectionRepository
{
	...
	public Task<IReadOnlyCollection<EducationDirection>> GetFiltered(string? code, string? name, string? type);

	public Task<IReadOnlyCollection<EducationDirection>> GetPagedFiltered(string? code, string? name, string? type, int page, int pageSize);
