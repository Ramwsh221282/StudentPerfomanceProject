...
public interface IEducationPlansRepository
{
	...
	public Task<IReadOnlyCollection<EducationPlan>> GetFiltered(string? directionName, string? directionCode, string? directionType, int? year);

	public Task<IReadOnlyCollection<EducationPlan>> GetPagedFiltered(string? directionName, string? directionCode, string? directionType, int? year, int page, int pageSize);
