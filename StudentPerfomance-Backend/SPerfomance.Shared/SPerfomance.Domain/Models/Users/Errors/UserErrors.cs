...
public static class UserErrors
{
    ...
    public static Error SurnameExcees(int length) =>
        new Error($"Фамилия превышает {length} символов");

    public static Error ThirdnameExcess(int length) =>
        new Error($"Отчество превышает {length} символов");
