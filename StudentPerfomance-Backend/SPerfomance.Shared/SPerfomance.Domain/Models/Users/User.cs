...
public class User : DomainEntity
{
    ...
    private User(Username username, UserEmail email, UserRole role, string hashedPassword)
        : base(Guid.NewGuid())
    {
        Name = username;
        Email = email;
    ...
    )
    {
        ...
        return Result<User>.Success(
            new(nameCreation.Value, emailCreation.Value, roleCreation.Value, hashedPassword)
        );
    }
